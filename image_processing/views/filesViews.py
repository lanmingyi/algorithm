...
from image_processing.service.filesService import resp_file_upload, resp_file_download
...
def get_ori_file(file_name):
    file_path = os.path.join('D:/usr/cv-spring/upload/', file_name)
...
def get_res_file(file_name):
    file_path = os.path.join('image_processing/results/', file_name)
