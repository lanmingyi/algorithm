...
class Attention(object):
    ...
    def __init__(self, dim, use_tanh=False, C=10, _name='Attention', _scope=''):
        ...
        with tf.compat.v1.variable_scope(_scope + _name):
            ...
            self.v = tf.compat.v1.get_variable('v', [1, dim], initializer=tf.keras.initializers.glorot_normal())
        ...
        self.project_ref = tf.keras.layers.Conv1D(dim, 1)
...
if __name__ == "__main__":
    ...
    print([logits, tf.nn.softmax(logits)])
