...
from yolo_utils1 import get_all_boxes, nms, post_process, xywh_to_xyxy, xyxy_to_xywh
...
def demo():
    ...
    for filename in files:
        ...
        # save results
        # print(os.path.join(resdir, os.path.basename(filename)))
        ...
        # cv2.imshow("yolo", img[:, :, (2, 1, 0)])  # (2, 1, 0)将图片从cv2.COLOR_BGR2RGB转换成BGR。H,W,C
        # # cv2.imshow("yolo", img)
        cv2.waitKey(0)
