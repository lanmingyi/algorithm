import os
from flask import *
from object_detection.yolov5.detect import run as yolov5_detect, parse_opt
from object_detection.mask_rcnn.prediction import run as mask_run_detect
...
@app.route('/objectDetection/yolov5', methods=['GET', 'POST'])
def yolov5_detect():
    data = request.json
...
@app.route('/objectDetection/maskRcnn', methods=['GET', 'POST'])
