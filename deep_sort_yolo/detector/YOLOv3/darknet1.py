...
from cfg1 import *
from region_layer1 import RegionLayer
from yolo_layer1 import YoloLayer
...
class Darknet(nn.Module):
    ...
    def load_binfile(self, weightfile):
        ...
        # torch.from_numpy() create a tensor from numpy.array
    ...
    def load_weights(self, weightfile):
        ...
        ind = -2
        for block in self.blocks:
            if start >= buf.size:  # buf.size:62001757
                break
            ind = ind + 1
            if block['type'] == 'net':
                continue
...
if __name__ == '__main__':
    # cfgfile = './cfg/yolo_v3.cfg'
    # weightfile = './weight/yolov3.weights'
    #
    #
    # print(cfgfile)
    # # print(sys.path)
    ...
    # # create_network = net.create_network(blocks)

    header = torch.tensor([0, 1, 0, 0])
    print(header)
