...
if __name__ == '__main__':
    ...
    test_set = LoadDatasetFromFolder(args, args.hr1_test, args.hr2_test, args.lab_test)
    ...
    test_loader = DataLoader(dataset=test_set, num_workers=args.num_workers, batch_size=1, shuffle=True)
    ...
    CDNet.load_state_dict(saved_state_dict)
    CDNet.train()
    print('CDNet', CDNet)
