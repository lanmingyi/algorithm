...
from tms.vrp_am.reinforce_baseline import validate

from tms.vrp_am.util import generate_data_onfly, get_results, get_cur_time
...
def train_model(optimizer,
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        for num_batch, x_batch in tqdm(enumerate(data.batch(batch)),
            ...
            if num_batch % batch_verbose == 0:
                print("Epoch {} (batch = {}): Loss: {}: Cost: {}".format(epoch, num_batch, epoch_loss_avg.result(),
        ...
        print(get_cur_time(),
              "Epoch {}: Loss: {}: Cost: {}".format(epoch, epoch_loss_avg.result(), epoch_cost_avg.result()))
