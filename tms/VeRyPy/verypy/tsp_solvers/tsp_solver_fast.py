...
from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_lkh import solve_tsp_lkh
from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_gurobi import solve_tsp_gurobi
...
if __name__=="__main__":
    from tms.VeRyPy.verypy.shared_cli import tsp_cli
