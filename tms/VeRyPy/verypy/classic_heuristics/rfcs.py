...
try:
    ...
    #  solver LKH.
    from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_lkh import solve_tsp_lkh as solve_tsp_intial
except ImportError:
    ...
    from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_ropt import solve_tsp_ropt as solve_tsp_intial
# Always use built-in TSP solver to guarantee 2 and 3-optimality of single routes.
from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_ropt import solve_tsp_2opt, solve_tsp_3opt
