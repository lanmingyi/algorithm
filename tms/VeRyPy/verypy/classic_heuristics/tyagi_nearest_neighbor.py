...
from tms.VeRyPy.verypy.classic_heuristics.nearest_neighbor import nearest_neighbor_init
...
from tms.VeRyPy.verypy.util import sol2routes, routes2sol, totald, objf
