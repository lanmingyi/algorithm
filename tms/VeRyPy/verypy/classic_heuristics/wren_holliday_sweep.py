...
from tms.VeRyPy.verypy.classic_heuristics.sweep import sweep_init, get_sweep_from_polar_coordinates,\
...
from tms.VeRyPy.verypy.local_search.intra_route_operators import do_2opt_move, do_relocate_move
from tms.VeRyPy.verypy.local_search.inter_route_operators import do_1point_move, do_chain_move,\
                                               do_insert_move,do_redistribute_move

from tms.VeRyPy.verypy.util import objf, without_empty_routes, is_better_sol
