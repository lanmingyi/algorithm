...
try:
    ...
    from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_gurobi import solve_tsp_gurobi as default_solve_tsp
    ## For very large instances one can optionally use faster LKH or acotsp local search.
    #from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_lkh import solve_tsp_lkh as default_solve_tsp  
    #from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_acotsp import solve_tsp_acotsp as default_solve_tsp
except ImportError:
    ...
    from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_ropt import solve_tsp_ropt as default_solve_tsp
