...
from tms.VeRyPy.verypy.classic_heuristics.sweep import _step,sweep_init,BEST_ALTERNATIVE
...
from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_ropt import solve_tsp_3opt as solve_tsp
