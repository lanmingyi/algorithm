...
try:
    ...
    from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_gurobi import solve_tsp_gurobi as solve_tsp
    ## For larger instances you might want to use ether of the faster TSP solvers.
    #from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_lkh import solve_tsp_lkh as solve_tsp
    #from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_acotsp import solve_tsp_acotsp as solve_tsp
except ImportError:
    ...
    from tms.VeRyPy.verypy.tsp_solvers.tsp_solver_ropt import solve_tsp_ropt as solve_tsp


from tms.VeRyPy.verypy.classic_heuristics.sweep import get_sweep_from_cartesian_coordinates, bisect_angle
from tms.VeRyPy.verypy.cvrp_io import calculate_D
from tms.VeRyPy.verypy.util import is_better_sol, totald
from tms.VeRyPy.verypy.config import MAX_MIP_SOLVER_RUNTIME, MIP_SOLVER_THREADS
from tms.VeRyPy.verypy.config import CAPACITY_EPSILON as C_EPS
from tms.VeRyPy.verypy.config import COST_EPSILON as S_EPS
...
def _end_of_thoroughfares_seed_points(points, D, d, C, K, trial=0):
    ...
    from tms.VeRyPy.verypy.util import produce_nn_list
...
if __name__=="__main__":
    from tms.VeRyPy.verypy.shared_cli import cli
