...
# project imports
from tms.VeRyPy.verypy.cvrp_io import generate_CVRP, read_TSPLIB_CVRP
from tms.VeRyPy.verypy.cvrp_io import write_TSPLIB_file, as_OPT_solution
from tms.VeRyPy.verypy.cvrp_ops import normalize_solution, validate_solution_feasibility
from random import randint, shuffle
from tms.VeRyPy.verypy.local_search.naive_implementations import do_naive_local_search, \
...
from tms.VeRyPy.verypy.local_search import LSOPT, do_local_search
from tms.VeRyPy.verypy.local_search.intra_route_operators import do_2opt_move, do_3opt_move,\
    do_relocate_move, do_exchange_move
from tms.VeRyPy.verypy.local_search.inter_route_operators import do_2optstar_move,\
    do_1point_move, do_2point_move
                         
from tms.VeRyPy.verypy.util import objf, sol2routes, routes2sol
from tms.VeRyPy.verypy.config import BENCHMARKS_BASEPATH
