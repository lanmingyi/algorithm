...
from tms.VeRyPy.verypy.cvrp_io import read_TSPLIB_CVRP, read_TSBLIB_additional_constraints
from tms.VeRyPy.verypy.cvrp_ops import validate_solution_feasibility, D2D_c
from tms.VeRyPy.verypy.util import objf, totald
from replicationbase import ReplicationBase
from tms.VeRyPy.verypy.classic_heuristics.petalvrp import petal_init, _remove_multiserved, \
