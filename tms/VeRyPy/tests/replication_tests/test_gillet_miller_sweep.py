...
from tms.VeRyPy.verypy.classic_heuristics.gillet_miller_sweep import gillet_miller_init, _shortest_path_through_nodes
from tms.VeRyPy.verypy.cvrp_ops import D2D_c, validate_solution_feasibility
...
class TestGilletMillerSweep(unittest.TestCase):
    ...
    def test_regression_small_static_case_with_C_and_L_constraints(self):
        ...
        #from tms.VeRyPy.verypy.cvrp_io import write_TSPLIB_file
